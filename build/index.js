	  ...
	  _createClass(Websocket, [{
	    ...
	    value: function setupWebsocket() {
	      ...
	      websocket.onerror = function (e) {
	        if (typeof _this.props.onError === 'function') _this.props.onError(e);
	      };
	      ...
	      websocket.onclose = function (evt) {
	        _this.logging('Websocket disconnected,the reason: ' + evt.reason + ',the code: ' + evt.code);
	        if (typeof _this.props.onClose === 'function') _this.props.onClose(evt.code, evt.reason);
	        if (_this.shouldReconnect) {
	          ...
	          _this.timeoutID = setTimeout(function () {
	            ...
	            _this.setState({
	              ws: window.WebSocket ? new window.WebSocket(_this.props.url, _this.props.protocol) : new window.MozWebSocket(_this.props.url, _this.props.protocol)
	            });
